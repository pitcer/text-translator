...
const TranslatorProvidersWidget = GObject.registerClass(
    class TranslatorProvidersWidget extends Gtk.Grid {
        ...
        _init() {
            ...
            this.attach(this._translators_combo, this.POSITIONS.translators.col, this.POSITIONS.translators.row, this.POSITIONS.translators.colspan, this.POSITIONS.translators.rowspan);
            ...
            this.attach(label, this.POSITIONS.default_source_label.col, this.POSITIONS.default_source_label.row, this.POSITIONS.default_source_label.colspan, this.POSITIONS.default_source_label.rowspan);
            ...
            this.attach(label, this.POSITIONS.default_target_label.col, this.POSITIONS.default_target_label.row, this.POSITIONS.default_target_label.colspan, this.POSITIONS.default_target_label.rowspan);
            ...
            this.attach(label, this.POSITIONS.last_used_label.col, this.POSITIONS.last_used_label.row, this.POSITIONS.last_used_label.colspan, this.POSITIONS.last_used_label.rowspan);
            ...
            this.attach(this._last_used, this.POSITIONS.last_used.col, this.POSITIONS.last_used.row, this.POSITIONS.last_used.colspan, this.POSITIONS.last_used.rowspan);
        ...
        _load_default_source(languages, active_id) {
            ...
            this.attach(this._source_languages_combo, this.POSITIONS.default_source.col, this.POSITIONS.default_source.row, this.POSITIONS.default_source.colspan, this.POSITIONS.default_source.rowspan);
        }
        ...
        _load_default_target(languages, active_id) {
            ...
            this.attach(this._target_languages_combo, this.POSITIONS.default_target.col, this.POSITIONS.default_target.row, this.POSITIONS.default_target.colspan, this.POSITIONS.default_target.rowspan);
        }
    ...
    class TranslatorKeybindingsWidget extends Gtk.Box {
        ...
        _refresh() {
            ...
            for (let settings_key in this._keybindings) {
                let [key, mods] = Gtk.accelerator_parse(Utils.SETTINGS.get_strv(settings_key)[0]);
...
const TranslatorPrefsGrid = GObject.registerClass(
    class TranslatorPrefsGrid extends Gtk.Grid {
        ...
        add_range(label, key, range_properties) {
            ...
            let range = Gtk.Scale.new_with_range(Gtk.Orientation.HORIZONTAL, range_properties.min, range_properties.max, range_properties.step);
            range.set_value(this._settings.get_int(key));
            range.set_draw_value(range_properties.draw_value);

            if (range_properties.add_mark) {
                range.add_mark(range_properties.mark_position, Gtk.PositionType.BOTTOM, null);
            }
...
const TextTranslatorPrefsWidget = GObject.registerClass(
    class TextTranslatorPrefsWidget extends Gtk.Box {
        ...
        _get_main_page() {
            ...
            page.add_boolean('Sync entries scrolling:', PrefsKeys.SYNC_ENTRIES_SCROLL_KEY);
            page.add_boolean('Enable shortcuts:', PrefsKeys.ENABLE_SHORTCUTS_KEY);
            page.add_boolean('Show the most used languages:', PrefsKeys.SHOW_MOST_USED_KEY);
            page.add_boolean('Auto speak result:', PrefsKeys.ENABLE_AUTO_SPEAK_KEY);
            ...
            page.add_spin('Font size:', PrefsKeys.FONT_SIZE_KEY, spin_properties)
        ...
        _get_size_page() {
            ...
            page.add_range('Width (% of screen):', PrefsKeys.WIDTH_PERCENTS_KEY, range_properties)
            page.add_range('Height (% of screen):', PrefsKeys.HEIGHT_PERCENTS_KEY, range_properties)
        ...
        _get_keybindings_page() {
            ...
            let keybindings = {};
            keybindings[PrefsKeys.OPEN_TRANSLATOR_KEY] = 'Open tranlator dialog';
            keybindings[PrefsKeys.TRANSLATE_FROM_CLIPBOARD_KEY] = 'Translate from clipboard';
            keybindings[PrefsKeys.TRANSLATE_FROM_SELECTION_KEY] = 'Translate from primary selection';
